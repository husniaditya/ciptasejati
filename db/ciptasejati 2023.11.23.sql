...
-- Dumping data for table ciptasejati.m_anggota: ~2 rows (approximately)
REPLACE INTO `m_anggota` (`ANGGOTA_ID`, `CABANG_ID`, `TINGKATAN_ID`, `ANGGOTA_KTP`, `ANGGOTA_NAMA`, `ANGGOTA_ALAMAT`, `ANGGOTA_PEKERJAAN`, `ANGGOTA_KELAMIN`, `ANGGOTA_TEMPAT_LAHIR`, `ANGGOTA_TANGGAL_LAHIR`, `ANGGOTA_HP`, `ANGGOTA_EMAIL`, `ANGGOTA_PIC`, `ANGGOTA_JOIN`, `ANGGOTA_RESIGN`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('09.03.2023.0001', 'RTG-0923-0001', 'SBK-0923-0002', '1234567891011', 'Husni Aditya', 'Surabaya', NULL, 'L', 'Surabaya', '1990-08-21', '087702462220', 'asdas@mail.com', NULL, '2023-09-21', NULL, '0', NULL, NULL),
	('admincs01', NULL, NULL, NULL, 'Admin CS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
...
-- Dumping data for table ciptasejati.m_cabang: ~0 rows (approximately)
...
-- Dumping data for table ciptasejati.m_daerah: ~2 rows (approximately)
REPLACE INTO `m_daerah` (`DAERAH_ID`, `PUSAT_ID`, `DAERAH_DESKRIPSI`, `DAERAH_SEKRETARIAT`, `DAERAH_PENGURUS`, `DAERAH_MAP`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('001.001', '001', 'Kalimantan Selatan', NULL, NULL, NULL, '0', '09.03.2023.0001', '2023-11-23 08:00:32'),
	('001.002', '001', 'Jawa Timur', NULL, NULL, NULL, '0', '09.03.2023.0001', '2023-11-23 08:06:32');
...
-- Dumping data for table ciptasejati.m_menu: ~28 rows (approximately)
...
-- Dumping data for table ciptasejati.m_pusat: ~2 rows (approximately)
REPLACE INTO `m_pusat` (`PUSAT_ID`, `PUSAT_DESKRIPSI`, `PUSAT_SEKRETARIAT`, `PUSAT_KEPENGURUSAN`, `PUSAT_MAP`, `PUSAT_LAT`, `PUSAT_LONG`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('001', 'Kalimantan Selatan', 'Jln Pembangunan Ujung Rt 34 No, 30 Banjarmasin, Kalimantan Selatan', '-', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.177112189075!2d114.56663797386034!3d-3.306319941168371!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de4224cfc2f6dc7%3A0x6bf4b37319f90a83!2sSekretariat%20Bela%20Diri%20Silat%20CIPTA%20SEJATI!5e0!3m2!1sen!2sid!4v1698203909709!5m2!1sen!2sid', '-3.3063120100780785', '114.56921894055016', '0', '09.03.2023.0001', '2023-11-22 17:01:57');
...
REPLACE INTO `m_tingkatan` (`TINGKATAN_ID`, `TINGKATAN_NAMA`, `TINGKATAN_GELAR`, `TINGKATAN_SEBUTAN`, `TINGKATAN_LEVEL`, `TINGKATAN_AKSES`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	...
	('1029ad73-845a-11ee-a3a1-e86a64d05f05', 'Merah-II', 'GMy', 'Guru Madya', 11, NULL, '0', 'admincs01', '2023-11-16 15:28:04'),
	...
	('cf7f4290-8391-11ee-9d33-e86a64d05f05', 'Putih', '-', 'Pra Pemula', 1, NULL, '0', '09.03.2023.0001', '2023-11-16 14:38:33');
...
REPLACE INTO `m_user` (`ANGGOTA_ID`, `USER_PASSWORD`, `USER_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('09.03.2023.0001', '$2y$12$HeACI0qKB.2Wv6xVExoGvuZUgJpzrs97qbnNhGSvDU1oNkhyYyEn6', '0', 'SYSTEM', NULL),
	('admincs', NULL, '0', 'SYSTEM', NULL),
	('admincs01', '$2y$12$/euSbZR2DLniY7zpjJkztOnG72rMolrscK2N3UxSykgjJ0CNjPU0y', '0', 'SYSTEM', '2023-09-17 21:07:59');
