...
-- Dumping database structure for u595728248_ciptasejati
CREATE DATABASE IF NOT EXISTS `ciptasejati` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ciptasejati`;

-- Dumping structure for table u595728248_ciptasejati.c_footer
...
-- Dumping data for table u595728248_ciptasejati.c_footer: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.c_footer_detail
...
-- Dumping data for table u595728248_ciptasejati.c_footer_detail: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.c_header
...
-- Dumping data for table u595728248_ciptasejati.c_header: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.c_header_detail
...
-- Dumping data for table u595728248_ciptasejati.c_header_detail: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.d_idsertifikat
DROP TABLE IF EXISTS `d_idsertifikat`;
CREATE TABLE IF NOT EXISTS `d_idsertifikat` (
  `IDSERTIFIKAT_ID` varchar(50) DEFAULT NULL,
  `FILE` text DEFAULT NULL,
  KEY `IDSERTIFIKAT_ID` (`IDSERTIFIKAT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table u595728248_ciptasejati.d_idsertifikat: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.d_pusatdata
DROP TABLE IF EXISTS `d_pusatdata`;
CREATE TABLE IF NOT EXISTS `d_pusatdata` (
  `PUSATDATA_ID` varchar(50) DEFAULT NULL,
  `PUSATDATA_FILE` text DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  KEY `PUSATDATA_ID` (`PUSATDATA_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table u595728248_ciptasejati.d_pusatdata: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.m_anggota
DROP TABLE IF EXISTS `m_anggota`;
CREATE TABLE IF NOT EXISTS `m_anggota` (
  `ANGGOTA_KEY` varchar(100) NOT NULL,
  `ANGGOTA_ID` varchar(50) NOT NULL,
  `CABANG_KEY` varchar(50) DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) DEFAULT NULL,
  `ANGGOTA_KTP` varchar(50) DEFAULT NULL,
  `ANGGOTA_NAMA` varchar(50) DEFAULT NULL,
  `ANGGOTA_ALAMAT` text DEFAULT NULL,
  `ANGGOTA_AGAMA` varchar(50) DEFAULT NULL,
  ...
  `ANGGOTA_AKSES` varchar(50) DEFAULT NULL,
  `ANGGOTA_STATUS` varchar(50) DEFAULT '0' COMMENT '0: Aktif / 1: Non Aktif / 2: Mutasi',
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_anggota: ~5 rows (approximately)
REPLACE INTO `m_anggota` (`ANGGOTA_KEY`, `ANGGOTA_ID`, `CABANG_KEY`, `TINGKATAN_ID`, `ANGGOTA_KTP`, `ANGGOTA_NAMA`, `ANGGOTA_ALAMAT`, `ANGGOTA_AGAMA`, `ANGGOTA_PEKERJAAN`, `ANGGOTA_KELAMIN`, `ANGGOTA_TEMPAT_LAHIR`, `ANGGOTA_TANGGAL_LAHIR`, `ANGGOTA_HP`, `ANGGOTA_EMAIL`, `ANGGOTA_PIC`, `ANGGOTA_JOIN`, `ANGGOTA_RESIGN`, `ANGGOTA_AKSES`, `ANGGOTA_STATUS`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	...
	('9d82e92a-928d-11ee-9020-e86a64d05f05', '09.03.2023.0001', '65741a93-9640-11ee-9fd3-e86a64d05f05', 'b19a6e57-98dd-11ee-bdd6-e86a64d05f05', '1234567891011', 'Husni Aditya', 'Sidoarjo', 'Islam', 'test', 'L', 'Surabaya', '1990-08-21', '087702462220', 'asdas@mail.com', './assets/images/daftaranggota/Kotawaringin Timur/Husni Aditya_001/husni.jpg', '2023-09-21', NULL, 'Administrator', '0', '0', '09.03.2023.0001', '2023-12-13 07:27:44'),
...
-- Dumping structure for table u595728248_ciptasejati.m_anggotaakses
...
CREATE TABLE IF NOT EXISTS `m_anggotaakses` (
  ...
  `ANGGOTA_KEY` varchar(50) DEFAULT NULL COMMENT 'm_user',
...
-- Dumping data for table u595728248_ciptasejati.m_anggotaakses: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.m_anggota_log
DROP TABLE IF EXISTS `m_anggota_log`;
CREATE TABLE IF NOT EXISTS `m_anggota_log` (
  `ANGGOTALOG_KEY` varchar(100) NOT NULL,
  `ANGGOTA_KEY` varchar(100) NOT NULL,
  `ANGGOTA_ID` varchar(50) NOT NULL,
  `CABANG_KEY` varchar(50) DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_anggota_log: ~39 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_cabang
DROP TABLE IF EXISTS `m_cabang`;
CREATE TABLE IF NOT EXISTS `m_cabang` (
  `CABANG_KEY` varchar(50) NOT NULL,
  `DAERAH_KEY` varchar(50) DEFAULT NULL COMMENT 'm_daerah',
  `CABANG_ID` varchar(50) NOT NULL,
  `CABANG_DESKRIPSI` varchar(50) DEFAULT NULL,
  `CABANG_SEKRETARIAT` text DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_cabang: ~62 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_daerah
DROP TABLE IF EXISTS `m_daerah`;
CREATE TABLE IF NOT EXISTS `m_daerah` (
  `DAERAH_KEY` varchar(50) NOT NULL,
  `PUSAT_KEY` varchar(50) DEFAULT NULL COMMENT 'm_pusat',
...
-- Dumping data for table u595728248_ciptasejati.m_daerah: ~11 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_data
DROP TABLE IF EXISTS `m_data`;
CREATE TABLE IF NOT EXISTS `m_data` (
  `DATA_ID` varchar(100) NOT NULL,
  `DATA_KATEGORI` varchar(100) DEFAULT NULL,
  `DATA_JUDUL` text DEFAULT NULL,
  `DATA_DESKRIPSI` text DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_data: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.m_idsertifikat
DROP TABLE IF EXISTS `m_idsertifikat`;
CREATE TABLE IF NOT EXISTS `m_idsertifikat` (
  `IDSERTIFIKAT_ID` varchar(100) NOT NULL,
  `TINGKATAN_ID` varchar(100) NOT NULL,
  `IDSERTIFIKAT_DESKRIPSI` text DEFAULT NULL,
  `IDSERTIFIKAT_IDFILE` text DEFAULT NULL,
  `IDSERTIFIKAT_IDNAMA` text DEFAULT NULL,
  `IDSERTIFIKAT_SERTIFIKATFILE` text DEFAULT NULL,
  `IDSERTIFIKAT_SERTIFIKATNAMA` text DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_idsertifikat: ~7 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_institut
DROP TABLE IF EXISTS `m_institut`;
CREATE TABLE IF NOT EXISTS `m_institut` (
  `INST_ID` varchar(50) NOT NULL,
  `INST_LOGO` text DEFAULT NULL,
  `INST_NAMA` varchar(50) DEFAULT NULL,
  `INST_TELP` text DEFAULT NULL,
  `INST_SEJARAH` text DEFAULT NULL,
  `INST_VISI` text DEFAULT NULL,
  `INST_MISI` text DEFAULT NULL,
  `INST_LAMBANG` text DEFAULT NULL,
  `INST_WARNA` text DEFAULT NULL,
  `INST_MAKNA` text DEFAULT NULL,
  PRIMARY KEY (`INST_ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table u595728248_ciptasejati.m_institut: ~1 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_menu
...
-- Dumping data for table u595728248_ciptasejati.m_menu: ~53 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_menuakses
...
-- Dumping data for table u595728248_ciptasejati.m_menuakses: ~212 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_pusat
DROP TABLE IF EXISTS `m_pusat`;
CREATE TABLE IF NOT EXISTS `m_pusat` (
  `PUSAT_KEY` varchar(50) NOT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_pusat: ~1 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_pusatdata
DROP TABLE IF EXISTS `m_pusatdata`;
CREATE TABLE IF NOT EXISTS `m_pusatdata` (
  `PUSATDATA_ID` varchar(100) NOT NULL,
  `CABANG_KEY` varchar(100) DEFAULT NULL,
  `PUSATDATA_KATEGORI` varchar(100) DEFAULT NULL,
  `PUSATDATA_JUDUL` varchar(100) DEFAULT NULL,
  `PUSATDATA_DESKRIPSI` text DEFAULT NULL,
  `PUSATDATA_FILE` text DEFAULT NULL,
  `PUSATDATA_FILENAMA` text DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_pusatdata: ~6 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_ranting
...
-- Dumping data for table u595728248_ciptasejati.m_ranting: ~1 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_tingkatan
DROP TABLE IF EXISTS `m_tingkatan`;
CREATE TABLE IF NOT EXISTS `m_tingkatan` (
  `TINGKATAN_ID` varchar(100) NOT NULL,
  `TINGKATAN_NAMA` varchar(100) DEFAULT NULL,
  `TINGKATAN_GELAR` varchar(50) DEFAULT NULL,
  `TINGKATAN_SEBUTAN` varchar(50) DEFAULT NULL,
  `TINGKATAN_LEVEL` int(11) DEFAULT NULL,
  `TINGKATAN_AKSES` varchar(50) DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_tingkatan: ~13 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_user
DROP TABLE IF EXISTS `m_user`;
CREATE TABLE IF NOT EXISTS `m_user` (
  `ANGGOTA_KEY` varchar(50) NOT NULL,
...
-- Dumping data for table u595728248_ciptasejati.m_user: ~3 rows (approximately)
...
-- Dumping structure for table u595728248_ciptasejati.m_user_log
...
-- Dumping data for table u595728248_ciptasejati.m_user_log: ~0 rows (approximately)

-- Dumping structure for table u595728248_ciptasejati.p_param
...
-- Dumping data for table u595728248_ciptasejati.p_param: ~2 rows (approximately)
REPLACE INTO `p_param` (`KATEGORI`, `CODE`, `DESK`) VALUES
	('STATUS', '0', 'Aktif'),
	('STATUS', '1', 'Tidak Aktif');

-- Dumping structure for table u595728248_ciptasejati.t_mutasi
DROP TABLE IF EXISTS `t_mutasi`;
CREATE TABLE IF NOT EXISTS `t_mutasi` (
  `MUTASI_ID` varchar(50) NOT NULL,
  `CABANG_AWAL` varchar(50) DEFAULT NULL,
  `CABANG_TUJUAN` varchar(50) DEFAULT NULL,
  `ANGGOTA_KEY` varchar(50) DEFAULT NULL,
  `MUTASI_DESKRIPSI` text DEFAULT NULL,
  `MUTASI_TANGGAL` date DEFAULT NULL,
  `MUTASI_STATUS` varchar(50) DEFAULT NULL,
  `MUTASI_STATUS_TANGGAL` datetime DEFAULT NULL,
  `MUTASI_APPROVE_BY` varchar(50) DEFAULT NULL,
  `MUTASI_APPROVE_TANGGAL` datetime DEFAULT NULL,
  `MUTASI_FILE` text DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT NULL,
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.t_mutasi: ~1 rows (approximately)
REPLACE INTO `t_mutasi` (`MUTASI_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `ANGGOTA_KEY`, `MUTASI_DESKRIPSI`, `MUTASI_TANGGAL`, `MUTASI_STATUS`, `MUTASI_STATUS_TANGGAL`, `MUTASI_APPROVE_BY`, `MUTASI_APPROVE_TANGGAL`, `MUTASI_FILE`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-24 16:33:15', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', '09.03.2023.0001', '2023-12-21 16:41:51');

-- Dumping structure for table u595728248_ciptasejati.t_mutasi_log
DROP TABLE IF EXISTS `t_mutasi_log`;
CREATE TABLE IF NOT EXISTS `t_mutasi_log` (
  `MUTASILOG_KEY` varchar(50) NOT NULL,
  `MUTASI_ID` varchar(50) DEFAULT NULL,
  `CABANG_AWAL` varchar(50) DEFAULT NULL,
  `CABANG_TUJUAN` varchar(50) DEFAULT NULL,
  `ANGGOTA_KEY` varchar(50) DEFAULT NULL,
  `MUTASI_DESKRIPSI` text DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.t_mutasi_log: ~41 rows (approximately)
REPLACE INTO `t_mutasi_log` (`MUTASILOG_KEY`, `MUTASI_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `ANGGOTA_KEY`, `MUTASI_DESKRIPSI`, `MUTASI_TANGGAL`, `MUTASI_STATUS`, `MUTASI_STATUS_TANGGAL`, `MUTASI_APPROVE_BY`, `MUTASI_APPROVE_TANGGAL`, `MUTASI_FILE`, `DELETION_STATUS`, `LOG_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('0424201f-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 17:30:52', '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:30:52'),
	('0831c873-a140-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-23 03:04:48'),
	('0b15cdaf-9ff2-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 18:14:01'),
	('12f8f56c-9ff2-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 18:14:14', '', '0', 'U', '09.03.2023.0001', '2023-12-21 18:14:14'),
	('1c700d10-a27a-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 16:33:04'),
	('22e67748-a0a6-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 15:43:10'),
	('2348f89d-a27a-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-24 16:33:15', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 16:33:15'),
	('25473380-a275-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 15:57:31'),
	('2710101e-a270-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'D', '09.03.2023.0001', '2023-12-24 15:21:47'),
	('29242f2c-a275-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-24 15:57:37', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 15:57:38'),
	('2b6842d5-9fe5-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'I', '09.03.2023.0001', '2023-12-21 16:41:51'),
	('2b912fba-a09e-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 14:46:09', '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:46:09'),
	('333f99fc-a0a6-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 15:43:37', '', '0', 'U', '09.03.2023.0001', '2023-12-22 15:43:37'),
	('41626eed-a09d-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:39:36'),
	('428abe75-a270-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'D', '09.03.2023.0001', '2023-12-24 15:22:33'),
	('4409ef9f-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:32:39'),
	('446b18ce-a0d4-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:13:23'),
	('48c299ab-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 17:32:47', '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:32:47'),
	('4ce0f596-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:32:54'),
	('510521ae-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 17:33:01', '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:33:01'),
	('530bc020-a270-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'D', '09.03.2023.0001', '2023-12-24 15:23:00'),
	('53ee9353-9fec-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:33:06'),
	('58ab6c84-a0d4-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 14:13:57', '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:13:57'),
	('5e4a67f6-a0d4-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:14:07'),
	('66ccbb0d-a0b9-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 11:01:04'),
	('68f748a5-a0d4-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 14:14:24', '', '0', 'U', '09.03.2023.0001', '2023-12-22 14:14:24'),
	('6e0a71d1-a270-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'D', '09.03.2023.0001', '2023-12-24 15:23:46'),
	('6e6273c8-9ff1-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 18:09:38'),
	('7e86b391-a07e-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 10:59:24', '', '0', 'U', '09.03.2023.0001', '2023-12-22 10:59:24'),
	('89d6199b-9ff1-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '2', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 18:10:24', '', '0', 'U', '09.03.2023.0001', '2023-12-21 18:10:24'),
	('9a6fbcf7-9fef-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 17:56:33', '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:56:33'),
	('9c9f5f2d-9ff2-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 18:18:05'),
	('9d5f73b9-a0bf-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 11:45:33', '', '0', 'U', '09.03.2023.0001', '2023-12-22 11:45:33'),
	('9e80f717-a278-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 16:22:23'),
	('9f3a7024-a270-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'D', '09.03.2023.0001', '2023-12-24 15:25:08'),
	('a7e76473-a278-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-24 16:22:39', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-24 16:22:39'),
	('c49f3453-9fef-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:57:43'),
	('c51f9a82-a0a5-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '0', '2023-12-21 16:41:51', NULL, NULL, '', '0', 'U', '09.03.2023.0001', '2023-12-22 15:40:33'),
	('cc829251-a0a5-11ee-ac2d-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '2', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 15:40:45', '', '0', 'U', '09.03.2023.0001', '2023-12-22 15:40:45'),
	('cc9aea6b-9fef-11ee-9d95-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-21 17:57:57', '', '0', 'U', '09.03.2023.0001', '2023-12-21 17:57:57'),
	('e0a60e92-a140-11ee-a157-0d0a0a14472b', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-23 03:10:51', './assets/report/mutasi/Seruyan/MTS-202312-001 Mutasi Anggota anu  30 January 2024.pdf', '0', 'U', '09.03.2023.0001', '2023-12-23 03:10:51');

-- Dumping structure for table u595728248_ciptasejati.t_notifikasi
DROP TABLE IF EXISTS `t_notifikasi`;
CREATE TABLE IF NOT EXISTS `t_notifikasi` (
  `NOTIFIKASI_ID` varchar(50) NOT NULL,
  `NOTIFIKASI_USER` varchar(50) NOT NULL,
  ...
  `APPROVE_STATUS` varchar(50) DEFAULT '0',
  `READ_STATUS` varchar(50) DEFAULT NULL COMMENT '0: Unread / 1: Read',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` varchar(50) DEFAULT NULL,
...
-- Dumping data for table u595728248_ciptasejati.t_notifikasi: ~6 rows (approximately)
REPLACE INTO `t_notifikasi` (`NOTIFIKASI_ID`, `NOTIFIKASI_USER`, `DOKUMEN_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `KATEGORI`, `SUBJECT`, `BODY`, `APPROVE_STATUS`, `READ_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('237d0385-a27a-11ee-a157-0d0a0a14472b', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '1', '0', '09.03.2023.0001', '2023-12-24 16:33:16'),
	('237d0566-a27a-11ee-a157-0d0a0a14472b', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '1', '0', '09.03.2023.0001', '2023-12-24 16:33:16'),
	('294d9f46-a275-11ee-a157-0d0a0a14472b', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-24 15:57:38'),
	('294da151-a275-11ee-a157-0d0a0a14472b', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-24 15:57:38'),
	('a82398d0-a278-11ee-a157-0d0a0a14472b', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-24 16:22:39'),
	('a8239c06-a278-11ee-a157-0d0a0a14472b', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-24 16:22:39');

-- Dumping structure for table u595728248_ciptasejati.t_ppd
DROP TABLE IF EXISTS `t_ppd`;
CREATE TABLE IF NOT EXISTS `t_ppd` (
  `PPD_ID` varchar(50) NOT NULL,
  `ANGGOTA_KEY` varchar(50) DEFAULT NULL,
  `CABANG_KEY` varchar(50) DEFAULT NULL,
  `SABUK_ID` varchar(50) DEFAULT NULL,
  `PPD_TANGGAL` date DEFAULT NULL,
  `PPD_DESKRIPSI` text DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`PPD_ID`),
...
-- Dumping data for table u595728248_ciptasejati.t_ppd: ~0 rows (approximately)
