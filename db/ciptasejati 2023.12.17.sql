...
CREATE TABLE IF NOT EXISTS `m_anggota` (
  `ANGGOTA_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ANGGOTA_ID` varchar(50) NOT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `ANGGOTA_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '0' COMMENT '0: Aktif / 1: Non Aktif / 2: Mutasi',
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_anggotaakses` (
  `MENU_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_menu',
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_user',
  `VIEW` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ADD` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `EDIT` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `DELETE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `APPROVE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `PRINT` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_BY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_anggota_log` (
  ...
  `ANGGOTA_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ANGGOTA_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_KTP` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_NAMA` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_ALAMAT` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `ANGGOTA_AGAMA` varchar(50) DEFAULT NULL,
  `ANGGOTA_PEKERJAAN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_KELAMIN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_TEMPAT_LAHIR` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_TANGGAL_LAHIR` date DEFAULT NULL,
  `ANGGOTA_HP` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_EMAIL` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `ANGGOTA_PIC` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `ANGGOTA_JOIN` date DEFAULT NULL,
  `ANGGOTA_RESIGN` date DEFAULT NULL,
  `DELETION_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '0',
  `LOG_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_BY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table ciptasejati.m_anggota_log: ~27 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_cabang` (
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `DAERAH_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_daerah',
  `CABANG_ID` varchar(50) NOT NULL,
  `CABANG_DESKRIPSI` varchar(50) DEFAULT NULL,
  `CABANG_SEKRETARIAT` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE IF NOT EXISTS `m_daerah` (
  `DAERAH_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `PUSAT_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'm_pusat',
...
CREATE TABLE IF NOT EXISTS `m_idsertifikat` (
  ...
  `IDSERTIFIKAT_IDNAMA` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `IDSERTIFIKAT_SERTIFIKATFILE` text,
  `IDSERTIFIKAT_SERTIFIKATNAMA` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_institut` (
  `INST_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `INST_LOGO` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `INST_NAMA` varchar(50) DEFAULT NULL,
  `INST_TELP` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `INST_SEJARAH` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `INST_VISI` text,
  `INST_MISI` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `INST_LAMBANG` text,
  `INST_WARNA` text,
  `INST_MAKNA` text,
...
REPLACE INTO `m_menu` (`MENU_ID`, `MENU_ICON`, `MENU_INDUK`, `MENU_NAMA`, `MENU_DESKRIPSI`, `MENU_LEVEL`, `MENU_URL`, `MENU_TARGET`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	...
	('5.5.4', NULL, '5.5', 'Halaman Tentang Kami', NULL, 'level3', 'kontententang.php', NULL, '0', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `m_pusat` (
  `PUSAT_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `m_pusatdata` (
  ...
  `CABANG_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dumping data for table ciptasejati.m_pusatdata: ~5 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_tingkatan` (
  `TINGKATAN_ID` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `TINGKATAN_NAMA` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `TINGKATAN_GELAR` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `TINGKATAN_SEBUTAN` varchar(50) DEFAULT NULL,
  `TINGKATAN_LEVEL` int DEFAULT NULL,
  `TINGKATAN_AKSES` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_user` (
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `USER_PASSWORD` varchar(200) DEFAULT NULL,
  `USER_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '0',
...
-- Dumping data for table ciptasejati.t_mutasi: ~3 rows (approximately)
REPLACE INTO `t_mutasi` (`MUTASI_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `ANGGOTA_KEY`, `MUTASI_DESKRIPSI`, `MUTASI_TANGGAL`, `MUTASI_STATUS`, `MUTASI_STATUS_TANGGAL`, `MUTASI_APPROVE_TANGGAL`, `MUTASI_FILE`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '657413ba-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'Test', '2023-12-24', '0', '2023-12-12 17:05:53', NULL, NULL, '0', '09.03.2023.0001', '2023-12-14 16:59:56'),
	('MTS-202312-002', '657413ba-9640-11ee-9fd3-e86a64d05f05', '65732ad6-9640-11ee-9fd3-e86a64d05f05', 'e9c39154-9b25-11ee-8519-e86a64d05f05', 'test', '2024-01-24', '1', '2023-12-13 13:06:00', '2023-12-15 13:06:00', '', '0', '09.03.2023.0001', '2023-12-15 17:20:15'),
	('MTS-202312-003', '657413ba-9640-11ee-9fd3-e86a64d05f05', '65732ad6-9640-11ee-9fd3-e86a64d05f05', 'e9c39154-9b25-11ee-8519-e86a64d05f05', 'test', '2024-01-24', '2', '2023-12-14 17:06:16', '2023-12-17 17:06:16', '', '0', '09.03.2023.0001', '2023-12-15 17:20:15');
...
CREATE TABLE IF NOT EXISTS `t_mutasi_log` (
  `MUTASI_LOGKEY` varchar(50) NOT NULL,
  `MUTASI_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CABANG_AWAL` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CABANG_TUJUAN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `MUTASI_DESKRIPSI` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `MUTASI_TANGGAL` date DEFAULT NULL,
  `MUTASI_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `MUTASI_STATUS_TANGGAL` datetime DEFAULT NULL,
  `MUTASI_FILE` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `DELETION_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `LOG_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_BY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`MUTASI_LOGKEY`),
...
-- Dumping data for table ciptasejati.t_mutasi_log: ~0 rows (approximately)
REPLACE INTO `t_mutasi_log` (`MUTASI_LOGKEY`, `MUTASI_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `ANGGOTA_KEY`, `MUTASI_DESKRIPSI`, `MUTASI_TANGGAL`, `MUTASI_STATUS`, `MUTASI_STATUS_TANGGAL`, `MUTASI_FILE`, `DELETION_STATUS`, `LOG_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('8a064519-9b33-11ee-8519-e86a64d05f05', 'MTS-202312-002', '657413ba-9640-11ee-9fd3-e86a64d05f05', '65732ad6-9640-11ee-9fd3-e86a64d05f05', 'e9c39154-9b25-11ee-8519-e86a64d05f05', 'test', '2024-01-24', 'Pending', NULL, '', '0', 'I', '09.03.2023.0001', '2023-12-15 17:20:15');
...
CREATE TABLE IF NOT EXISTS `t_notifikasi` (
  ...
  `READ_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '0: Unread / 1: Read',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` varchar(50) DEFAULT NULL,
...
-- Dumping data for table ciptasejati.t_notifikasi: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `t_ppd` (
  ...
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
