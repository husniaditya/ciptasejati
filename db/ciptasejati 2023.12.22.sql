...
CREATE TABLE IF NOT EXISTS `m_anggota` (
  `ANGGOTA_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ANGGOTA_ID` varchar(50) NOT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `ANGGOTA_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '0: Aktif / 1: Non Aktif / 2: Mutasi',
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_anggotaakses` (
  `MENU_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_menu',
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_user',
  `VIEW` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ADD` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `EDIT` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DELETE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `APPROVE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `PRINT` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_anggota_log` (
  ...
  `ANGGOTA_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ANGGOTA_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_cabang',
  `TINGKATAN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_KTP` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_NAMA` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_ALAMAT` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ANGGOTA_AGAMA` varchar(50) DEFAULT NULL,
  `ANGGOTA_PEKERJAAN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_KELAMIN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_TEMPAT_LAHIR` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_TANGGAL_LAHIR` date DEFAULT NULL,
  `ANGGOTA_HP` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_EMAIL` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ANGGOTA_PIC` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ANGGOTA_JOIN` date DEFAULT NULL,
  `ANGGOTA_RESIGN` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_cabang` (
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `DAERAH_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_daerah',
  `CABANG_ID` varchar(50) NOT NULL,
  `CABANG_DESKRIPSI` varchar(50) DEFAULT NULL,
  `CABANG_SEKRETARIAT` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE IF NOT EXISTS `m_daerah` (
  `DAERAH_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `PUSAT_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'm_pusat',
...
CREATE TABLE IF NOT EXISTS `m_idsertifikat` (
  ...
  `IDSERTIFIKAT_DESKRIPSI` text,
  `IDSERTIFIKAT_IDFILE` text,
  `IDSERTIFIKAT_IDNAMA` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `IDSERTIFIKAT_SERTIFIKATFILE` text,
  `IDSERTIFIKAT_SERTIFIKATNAMA` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table ciptasejati.m_idsertifikat: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_institut` (
  `INST_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `INST_LOGO` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `INST_NAMA` varchar(50) DEFAULT NULL,
  `INST_TELP` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `INST_SEJARAH` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `INST_VISI` text,
  `INST_MISI` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `INST_LAMBANG` text,
  `INST_WARNA` text,
  `INST_MAKNA` text,
...
-- Dumping data for table ciptasejati.m_institut: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_menuakses` (
  `MENU_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `m_pusat` (
  `PUSAT_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `PUSAT_ID` varchar(50) NOT NULL,
  `PUSAT_DESKRIPSI` varchar(50) DEFAULT NULL,
  `PUSAT_SEKRETARIAT` text,
...
CREATE TABLE IF NOT EXISTS `m_pusatdata` (
  ...
  `CABANG_KEY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `PUSATDATA_KATEGORI` varchar(100) DEFAULT NULL,
  `PUSATDATA_JUDUL` varchar(100) DEFAULT NULL,
  `PUSATDATA_DESKRIPSI` text,
  `PUSATDATA_FILE` text,
  `PUSATDATA_FILENAMA` text,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_tingkatan` (
  `TINGKATAN_ID` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `TINGKATAN_NAMA` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TINGKATAN_GELAR` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TINGKATAN_SEBUTAN` varchar(50) DEFAULT NULL,
  `TINGKATAN_LEVEL` int DEFAULT NULL,
  `TINGKATAN_AKSES` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DELETION_STATUS` varchar(50) DEFAULT '0',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_user` (
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `USER_PASSWORD` varchar(200) DEFAULT NULL,
  `USER_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0',
...
REPLACE INTO `m_user` (`ANGGOTA_KEY`, `USER_PASSWORD`, `USER_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('9d82e92a-928d-11ee-9020-e86a64d05f05', '$2y$12$HeACI0qKB.2Wv6xVExoGvuZUgJpzrs97qbnNhGSvDU1oNkhyYyEn6', '0', 'SYSTEM', NULL),
...
-- Dumping data for table ciptasejati.t_mutasi: ~0 rows (approximately)
REPLACE INTO `t_mutasi` (`MUTASI_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `ANGGOTA_KEY`, `MUTASI_DESKRIPSI`, `MUTASI_TANGGAL`, `MUTASI_STATUS`, `MUTASI_STATUS_TANGGAL`, `MUTASI_APPROVE_BY`, `MUTASI_APPROVE_TANGGAL`, `MUTASI_FILE`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', '98436ea1-9a51-11ee-90cd-e86a64d05f05', 'test', '2024-01-30', '1', '2023-12-21 16:41:51', '09.03.2023.0001', '2023-12-22 15:43:37', '', '0', '09.03.2023.0001', '2023-12-21 16:41:51');
...
CREATE TABLE IF NOT EXISTS `t_mutasi_log` (
  `MUTASILOG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `MUTASI_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CABANG_AWAL` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CABANG_TUJUAN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MUTASI_DESKRIPSI` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `MUTASI_TANGGAL` date DEFAULT NULL,
  `MUTASI_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MUTASI_STATUS_TANGGAL` datetime DEFAULT NULL,
  `MUTASI_APPROVE_BY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MUTASI_APPROVE_TANGGAL` datetime DEFAULT NULL,
  `MUTASI_FILE` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `DELETION_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `LOG_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INPUT_BY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INPUT_DATE` datetime DEFAULT NULL,
...
-- Dumping data for table ciptasejati.t_mutasi_log: ~14 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `t_notifikasi` (
  ...
  `DOKUMEN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `CABANG_AWAL` varchar(50) DEFAULT NULL,
  `CABANG_TUJUAN` varchar(50) DEFAULT NULL,
  `KATEGORI` text,
  ...
  `READ_STATUS` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '0: Unread / 1: Read',
  `INPUT_BY` varchar(50) DEFAULT NULL,
  `INPUT_DATE` varchar(50) DEFAULT NULL,
...
-- Dumping data for table ciptasejati.t_notifikasi: ~8 rows (approximately)
REPLACE INTO `t_notifikasi` (`NOTIFIKASI_ID`, `NOTIFIKASI_USER`, `DOKUMEN_ID`, `CABANG_AWAL`, `CABANG_TUJUAN`, `KATEGORI`, `SUBJECT`, `BODY`, `APPROVE_STATUS`, `READ_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
	('12fa3c89-9ff2-11ee-9d95-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 18:14:14'),
	('12fa9e95-9ff2-11ee-9d95-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 18:14:14'),
	('2b68e470-9fe5-11ee-9d95-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 16:41:51'),
	('2b68ec8d-9fe5-11ee-9d95-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 16:41:51'),
	('2b92ef2c-a09e-11ee-ac2d-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 14:46:09'),
	('2b92fb3a-a09e-11ee-ac2d-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 14:46:09'),
	('3340d05b-a0a6-11ee-ac2d-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '1', '0', '09.03.2023.0001', '2023-12-22 15:43:37'),
	('3340ee37-a0a6-11ee-ac2d-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '1', '0', '09.03.2023.0001', '2023-12-22 15:43:37'),
	('7e894fe1-a07e-11ee-ac2d-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 10:59:24'),
	('7e896f09-a07e-11ee-ac2d-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 10:59:24'),
	('89d755bb-9ff1-11ee-9d95-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 18:10:24'),
	('89d75e67-9ff1-11ee-9d95-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 18:10:24'),
	('cc83c0fe-a0a5-11ee-ac2d-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 15:40:45'),
	('cc84057f-a0a5-11ee-ac2d-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-22 15:40:45'),
	('cc9bdadb-9fef-11ee-9d95-e86a64d05f05', '9d82e92a-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 17:57:57'),
	('cc9be2cd-9fef-11ee-9d95-e86a64d05f05', '9d83086f-928d-11ee-9020-e86a64d05f05', 'MTS-202312-001', '65741a93-9640-11ee-9fd3-e86a64d05f05', '6574008b-9640-11ee-9fd3-e86a64d05f05', 'Mutasi', 'Mutasi Anggota Approval', 'Mutasi a.n anu dari cabang Seruyan', '0', '1', '09.03.2023.0001', '2023-12-21 17:57:57');
...
CREATE TABLE IF NOT EXISTS `t_ppd` (
  ...
  `ANGGOTA_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CABANG_KEY` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
