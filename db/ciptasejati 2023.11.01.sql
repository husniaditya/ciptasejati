...
-- Dumping data for table ciptasejati.m_anggota: ~0 rows (approximately)
...
-- Dumping data for table ciptasejati.m_daerah: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_tingkatan` (
  `TINGKATAN_ID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `TINGKATAN_NAMA` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `TINGKATAN_DESKRIPSI` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `TINGKATAN_LEVEL` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dumping data for table ciptasejati.m_tingkatan: ~15 rows (approximately)
REPLACE INTO `m_tingkatan` (`TINGKATAN_ID`, `TINGKATAN_NAMA`, `TINGKATAN_DESKRIPSI`, `TINGKATAN_LEVEL`, `TINGKATAN_AKSES`, `DELETION_STATUS`, `INPUT_BY`, `INPUT_DATE`) VALUES
