									...
									<div class="row align-items-end pb-4">
										<div class="col-12 ps-5">
											<div class="appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">
												<img src="img/lazy.png" data-src="img/demos/renewable-energy/generic/generic-1.png" class="img-fluid border-radius lazyload">
											</div>
										</div>
									</div>
								</div>
					...
					<div class="container container-xl-custom pt-4 pb-5">
						<div class="row justify-content-between py-5">
							<div class="col-lg-6">
								...
								<h3 class="mb-3">Melestarikan budaya pencak silat indonesia</h3>
								<p class="mb-4 pb-2">Sebagai sarana dan prasarana silaturahmi dan mempererat tali persaudaraan, khususnya untuk melestarikan budaya pencak silat indonesia</p>
							</div>
							<div class="col-lg-5 mt-5 mt-lg-0 mb-5 mb-lg-0">
								<h4 class="text-cipta text-3 font-weight-bold mb-2">MISI</h4>
								<ul>
									<li><p class="mb-4 pb-2">Membuat generasi muda untuk mencintai budaya kita diantaranya pencak silat yang menjadi kebanggaan bangsa indonesia</p></li>
									<li><p class="mb-4 pb-2">Menciptakan karakter - karakter manusia yang ber akhlak mulia, bermental kuat dan mempunyai dasar - dasar etika yang baik</p></li>
									<li><p class="mb-4 pb-2">Mempunyai kedisiplinan dan kejujuran</p></li>
									<li><p class="mb-4 pb-2">Mencetak bibit - bibit pesilat yang baik dan handal</p></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">
									...
									<h4 class="font-weight-bold mt-4">Pelatihan</h4>
						...
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Penelitian & Pengembangan</h4>
									<p class="text-3">Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Proin mauris erat, accumsan quis ullamcorper.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="700" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Pendokumentasian</h4>
									<p class="text-3">Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Proin mauris erat, accumsan quis ullamcorper.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="1200" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Publikasi</h4>
									<p class="text-3">Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Proin mauris erat, accumsan quis ullamcorper.</p>
								</div>
							</div>
						</div>
					...
					<div class="container container-xl-custom">
						<div class="row justify-content-between align-items-center py-5">
							<div class="col-lg-3">
								...
								<a href="tim" class="btn btn-arrow-effect-1 ws-nowrap text-danger text-2 bg-transparent border-0 px-0 text-uppercase stretched-link">More Details <i class="fas fa-arrow-right ms-2"></i></a>
							</div>
							<div class="col-lg-8">
								<div class="carousel-half-full-width-wrapper carousel-half-full-width-right">
									<div class="owl-carousel owl-theme carousel-half-full-width-right nav-style-1 nav-dark nav-font-size-lg mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '768': {'items': 3}, '992': {'items': 3}, '1200': {'items': 3}}, 'loop': true, 'nav': true, 'dots': false, 'margin': 20}">
										<div class="p-relative">
											...
											<h4 class="font-weight-bold mt-4">Alpha</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-color-primary"></i> Gelar : Guru Muda</li>
											</ul>
										</div>
										<div class="p-relative">
											<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
											...
											<h4 class="font-weight-bold mt-4">Beta</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-color-primary"></i> Gelar : Guru Muda</li>
										...
										<div class="p-relative">
											...
											<h4 class="font-weight-bold mt-4">Charlie</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-color-primary"></i> Gelar : Guru Muda</li>
										...
										<div class="p-relative">
											...
											<h4 class="font-weight-bold mt-4">Delta</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-color-primary"></i> Gelar : Guru Muda</li>
						...
						<div class="row py-5">
							<div class="col-lg-6">
								...
								<div class="hstack gap-4 pt-3">
									<div>
										<a href="hubungi" class="btn btn-modern btn-cipta font-weight-bold border-0 py-3 px-5 btn-arrow-effect-1 ws-nowrap">KONTAK KAMI <i class="fas fa-arrow-right ms-2"></i></a>
									</div>
									<div class="vr"></div>
									<div>
								...
								<div class="accordion accordion-modern-status accordion-modern-status-cipta" id="accordion100">
									...
									<div class="card card-default">
										...
										<div id="collapse100Three" class="collapse" aria-labelledby="collapse100HeadingThree" data-bs-parent="#accordion100">
											<div class="card-body">
												<p class="mb-0">Adapun langkah-langkah untuk mereset password adalah:</p>
												<ul class="list list-icons list-danger font-weight-medium mt-3">
													<li>1 - Klik Tombol Lupa Password yang ada di pojok kanan bawah halaman login, kemudian anda akan diarahkan ke halaman reset password</li>
													<li>2 - Isikan semua data yang terdapat pada form reset password, kemudian tekan tombol reset password</li>
													<li>3 - Email verifikasi password akan dikirim melalui email, periksalah email anda dan pastikan anda menerima email</li>
													<li>4 - Kemudian klik link verifikasi password yang terdapat pada email, anda akan diarahkan ke halaman reset password</li>
													<li>5 - Setelah masuk ke menu verifikasi reset password anda bisa isikan password baru dan kemudian tekan tombol reset password</li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-6">
								<div class="row align-items-center p-relative">
									...
									<div class="col-lg-6 mt-4 mt-lg-0">
										...
										<a href="post" class="btn btn-arrow-effect-1 ws-nowrap text-danger text-2 bg-transparent border-0 px-0 text-uppercase stretched-link">Read More <i class="fas fa-arrow-right ms-2"></i></a>
									</div>
								</div>
							</div>
							<div class="col-lg-6 mt-5 mt-lg-0">
