				...
				<div class="container container-xl-custom pt-5 pb-3 mt-4">
					<div class="row">
						...
						<div class="col-lg-4 mb-5">
							...
							<h4 class="font-weight-bold mt-4">Bravo</h4>
							<ul class="list list-icons list-primary font-weight-medium mt-3">
								<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Solo</li>
								<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Merah-IV</li>
								<li><i class="fas fa-pen text-color-primary"></i> Gelar : Guru Besar</li>
							</ul>
						</div>
						<div class="col-lg-4 mb-5">
							<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
							...
							<ul class="list list-icons list-primary font-weight-medium mt-3">
								<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Sampit</li>
								<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Hitam-III</li>
								<li><i class="fas fa-pen text-color-primary"></i> Gelar : Pelatih Utama</li>
							</ul>
						</div>
						<div class="col-lg-4 mb-5">
							<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
							...
							<ul class="list list-icons list-primary font-weight-medium mt-3">
								<li><i class="fas fa-code-branch text-color-primary"></i> Cabang : Sampit</li>
								<li><i class="fas fa-chart-simple text-color-primary"></i> Tingkatan : Coklat</li>
								<li><i class="fas fa-pen text-color-primary"></i> Gelar : Asisten Pelatih</li>
							</ul>
						</div>
					</div>
				</div>
