...
$(document).ready(function() {
    $('#tingkatgelar-table').DataTable({
      ...
      columnDefs: [
        ...
        { width: '20%', targets: 6 }, // Set width for column 6
        { width: '15%', targets: 6 }, // Set width for column 6
...
$(document).ready(function() {
  ...
  $('#addTingkatGelar-form').submit(function(event) {
    ...
    if (tingkatannama !== '' && tingkatangelar !== '' && tingkatanlevel !== '') {
      $.ajax({
        type: 'POST',
  ...
  $('#editTingkatGelar-form').submit(function(event) {
    ...
    if (Edittingkatannama !== '' && Edittingkatangelar !== '' && Edittingkatanlevel !== '') {
      $.ajax({
        type: 'POST',
        url: 'module/backend/t_tingkatgelar.php',
        data: formData,
