        ...
        while ($data = $getData->fetch(PDO::FETCH_ASSOC)) {
            ...
            class MYPDF extends TCPDF {
                ...
                public function Footer() {
                    global $id, $encodedGuru, $encodedKoor, $USER_NAMA, $CABANG_TUJUAN_DES, $MUTASI_APPROVE_TANGGAL, $INPUT_BY, $INPUT_BY_ID, $APPROVE_BY, $APPROVE_BY_ID, $INPUT_AKSES, $APPROVE_AKSES, $CABANG_AWAL_DES, $DATENOW, $INPUT_DATE;
