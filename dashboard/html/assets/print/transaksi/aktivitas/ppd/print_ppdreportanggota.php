        ...
        while ($data = $getData->fetch(PDO::FETCH_ASSOC)) {
            ...
            class MYPDF extends TCPDF {
                ...
                public function Footer() {
                    global $USER_NAMA, $CABANG_DESKRIPSI, $PPD_PELATIH_TGL, $PPD_GURU_TGL, $PPD_APPROVE_PELATIH, $PPD_APPROVE_GURU, $PPD_APPROVE_PELATIH_BY, $PPD_APPROVE_GURU_BY, $PPD_KOORDINATOR, $PPD_GURU, $DATENOW;
