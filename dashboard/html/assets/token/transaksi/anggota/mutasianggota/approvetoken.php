...
if (isset($_GET["token"])) {
    ...
    if ($MUTASI_STATUS == 0) {
        ...
        select uuid(),ANGGOTA_KEY,'$USER_ID','$MUTASI_ID','$CABANG_AWAL','$CABANG_TUJUAN','Mutasi','ViewNotifMutasi','open-ViewNotifMutasi','Persetujuan Mutasi Anggota','Mutasi a.n $ANGGOTA_NAMA dari cabang $CABANG_AWAL', 1, 0, '$USER_ID', '$localDateTime'
        FROM m_anggota
