            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Persetujuan Guru PPD</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <li class="active">Persetujuan Guru PPD</li>
                            </ol>
                        </div>
                        <!--/ Toolbar -->
                    </div>
                ...
                <?php include 'module/component/transaksi/aktivitas/ppd/v_ppdApprovalGuru.php';?>
            </div>
        </section>
