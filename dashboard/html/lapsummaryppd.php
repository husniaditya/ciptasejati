            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Laporan Summary Pembukaan Pusat Daya</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <li class="active">Laporan Summary Pembukaan Pusat Daya</li>
                            </ol>
                        </div>
                        <!--/ Toolbar -->
                    </div>
                ...
                <?php include 'module/component/laporan/aktivitas/ppd/v_sumppd.php';?>
            </div>
        </section>
