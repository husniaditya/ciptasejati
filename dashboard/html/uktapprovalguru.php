            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">Persetujuan Guru Data Uji Kenaikan Tingkat</h4>
                    </div>
                    <div class="page-header-section">
                        <!-- Toolbar -->
                        <div class="toolbar">
                            <ol class="breadcrumb breadcrumb-transparent nm">
                                ...
                                <li class="active">Persetujuan Guru Uji Kenaikan Tingkat</li>
                            </ol>
                        </div>
                        <!--/ Toolbar -->
                    </div>
                ...
                <?php include 'module/component/transaksi/aktivitas/ukt/v_uktguru.php';?>
            </div>
        </section>
