...
$getPPDTanggal = GetQuery("SELECT DISTINCT DATE_FORMAT(PPD_TANGGAL, '%d %M %Y') PPD_TANGGAL_FORMAT, PPD_TANGGAL FROM t_ppd WHERE DELETION_STATUS = 0 AND PPD_APPROVE_PELATIH = 1 ORDER BY PPD_TANGGAL");
...
<div id="ViewPPDGuru" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="ViewPPDGuru-form" method="post" class="form" data-parsley-validate>
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                    <h3 class="semibold modal-title text-inverse">Data Summary PPD Anggota</h3>
                </div>
