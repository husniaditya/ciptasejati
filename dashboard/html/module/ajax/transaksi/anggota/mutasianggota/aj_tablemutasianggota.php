...
if (isset($_POST["DAERAH_KEY"]) || isset($_POST["CABANG_KEY"]) || isset($_POST["TINGKATAN_ID"]) || isset($_POST["ANGGOTA_ID"]) || isset($_POST["ANGGOTA_NAMA"]) || isset($_POST["MUTASI_STATUS"])) {
    ...
    WHERE (daetujuan.DAERAH_KEY LIKE CONCAT('%','$DAERAH_KEY','%')) and (cabtujuan.CABANG_KEY LIKE CONCAT('%','$CABANG_KEY','%')) AND (a.TINGKATAN_ID LIKE CONCAT('%','$TINGKATAN_ID','%')) AND (a.ANGGOTA_ID LIKE CONCAT('%','$ANGGOTA_ID','%')) AND (a.ANGGOTA_NAMA LIKE CONCAT('%','$ANGGOTA_NAMA','%'))AND (t.MUTASI_STATUS LIKE CONCAT('%','$MUTASI_STATUS','%'))
