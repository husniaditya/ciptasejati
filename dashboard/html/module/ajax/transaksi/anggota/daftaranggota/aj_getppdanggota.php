...
if (isset($_POST['id'])) {
    ...
    LEFT JOIN m_anggota a2 ON p.INPUT_BY = a2.ANGGOTA_ID AND a2.ANGGOTA_STATUS = 0
    ...
    while ($rowPPD = $getPPD->fetch(PDO::FETCH_ASSOC)) {
        ...
        ?>
        <tr>
            <td align="center"><a href="assets/print/transaksi/aktivitas/ppd/print_ppdreportanggota.php?id=<?= encodeIdToBase64($PPD_ID); ?>" target="_blank" style="color: #00b1e1;"><i class="fa-solid fa-print"></i> Cetak</a></td>
            <td>
                <?= $PPD_ID; ?><br> 
