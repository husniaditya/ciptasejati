...
if ($PPD_JENIS == "0") {
    ...
    $getListAnggota = GetQuery("SELECT a.*,t.TINGKATAN_NAMA FROM m_anggota a
    LEFT JOIN m_tingkatan t ON a.TINGKATAN_ID = t.TINGKATAN_ID
    WHERE t.TINGKATAN_ID = '$TINGKATAN_ID' AND a.ANGGOTA_STATUS = 0 AND a.DELETION_STATUS = 0 AND t.DELETION_STATUS = 0 AND a.ANGGOTA_AKSES <> 'Administrator' AND a.CABANG_KEY = '$CABANG_KEY' ORDER BY a.ANGGOTA_NAMA ASC");
