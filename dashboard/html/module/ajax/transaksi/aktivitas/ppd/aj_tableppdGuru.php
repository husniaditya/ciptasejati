...
if (isset($_POST["PPD_LOKASI"]) || isset($_POST["PPD_TANGGAL"])) {
    ...
    WHERE p.DELETION_STATUS = 0 AND p.PPD_APPROVE_PELATIH = 1 AND p.PPD_APPROVE_GURU = 0 AND (p.PPD_LOKASI LIKE CONCAT('%','$PPD_LOKASI','%')) AND (p.PPD_TANGGAL LIKE CONCAT('%','$PPD_TANGGAL','%'))
