...
if (isset($_POST["DAERAH_AWAL_KEY"]) || isset($_POST["CABANG_AWAL_KEY"]) || isset($_POST["DAERAH_TUJUAN_KEY"]) || isset($_POST["CABANG_TUJUAN_KEY"]) || isset($_POST["TINGKATAN_ID"]) || isset($_POST["ANGGOTA_ID"]) || isset($_POST["ANGGOTA_NAMA"]) || isset($_POST["MUTASI_STATUS"])) {
    ...
    if ($USER_AKSES == "Administrator" || $USER_AKSES == "Pengurus Daerah") {
        $DAERAH_AWAL_KEY = isset($_POST["DAERAH_AWAL_KEY"]) ? $_POST["DAERAH_AWAL_KEY"] : "";
        $CABANG_AWAL_KEY = isset($_POST["CABANG_AWAL_KEY"]) ? $_POST["CABANG_AWAL_KEY"] : "";
    } else {
        $DAERAH_AWAL_KEY = "";
        $CABANG_AWAL_KEY = "";
    }
    $DAERAH_TUJUAN_KEY = isset($_POST["DAERAH_TUJUAN_KEY"]) ? $_POST["DAERAH_TUJUAN_KEY"] : "";
    $CABANG_TUJUAN_KEY = isset($_POST["CABANG_TUJUAN_KEY"]) ? $_POST["CABANG_TUJUAN_KEY"] : "";
    $TINGKATAN_ID = isset($_POST["TINGKATAN_ID"]) ? $_POST["TINGKATAN_ID"] : "";
    $ANGGOTA_ID = isset($_POST["ANGGOTA_ID"]) ? $_POST["ANGGOTA_ID"] : "";
    $ANGGOTA_NAMA = isset($_POST["ANGGOTA_NAMA"]) ? $_POST["ANGGOTA_NAMA"] : "";
    $MUTASI_STATUS = isset($_POST["MUTASI_STATUS"]) ? $_POST["MUTASI_STATUS"] : "";

    $getMutasi = GetQuery("SELECT t.MUTASI_ID,daeawal.DAERAH_KEY AS DAERAH_AWAL_KEY,daeawal.DAERAH_DESKRIPSI AS DAERAH_AWAL_DES,t.CABANG_AWAL,cabawal.CABANG_DESKRIPSI AS CABANG_AWAL_DES,daetujuan.DAERAH_KEY AS DAERAH_TUJUAN_KEY,daetujuan.DAERAH_DESKRIPSI AS DAERAH_TUJUAN_DES,t.CABANG_TUJUAN,cabtujuan.CABANG_DESKRIPSI AS CABANG_TUJUAN_DES,a.ANGGOTA_KEY,a.ANGGOTA_ID,a.ANGGOTA_NAMA,a.TINGKATAN_ID,t2.TINGKATAN_NAMA,t2.TINGKATAN_SEBUTAN,t.MUTASI_DESKRIPSI,t.MUTASI_TANGGAL,t.MUTASI_STATUS,t.MUTASI_STATUS_TANGGAL,t.MUTASI_APPROVE_TANGGAL,a2.ANGGOTA_NAMA INPUT_BY,DATE_FORMAT(t.INPUT_DATE, '%d %M %Y %H:%i') INPUT_DATE,DATE_FORMAT(t.MUTASI_TANGGAL, '%d %M %Y %H:%i') MUTASI_TGL, DATE_FORMAT(t.MUTASI_STATUS_TANGGAL, '%d %M %Y %H:%i') MUTASI_STATUS_TANGGAL, DATE_FORMAT(t.MUTASI_TANGGAL, '%d %M %Y') TANGGAL_EFEKTIF,t.MUTASI_FILE,
    CASE 
