...
while ($rowMateri = $getMateri->fetch(PDO::FETCH_ASSOC)) {
    ...
    <tr>
        <td align="center">
            <button type="button" id="hapusdetail" data-id="<?= $_key; ?>" data-mtr="<?= $MATERI_ID; ?>" data-cbg="<?= $CABANG_KEY; ?>" class="hapusdetail btn btn-danger mb5"><span class="ico-trash"></span> </button>
        </td>
