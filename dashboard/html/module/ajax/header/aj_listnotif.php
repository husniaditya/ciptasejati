...
LEFT JOIN m_anggota a ON n.INPUT_BY = a.ANGGOTA_ID AND a.ANGGOTA_STATUS = 0 AND a.DELETION_STATUS = 0
LEFT JOIN m_cabang c ON a.CABANG_KEY = c.CABANG_KEY
WHERE NOTIFIKASI_USERID = '$USER_ID' ORDER BY READ_STATUS ASC,INPUT_DATE DESC LIMIT 15");
