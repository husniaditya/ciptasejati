...
if (isset($_POST["saveppd"])) {
    try {
        ...
        $getDataAnggota = GetQuery("SELECT TINGKATAN_ID TINGKATAN_ID_LAMA FROM m_anggota WHERE ANGGOTA_ID = '$ANGGOTA_ID' AND CABANG_KEY = '$CABANG_KEY' AND ANGGOTA_STATUS = 0");
