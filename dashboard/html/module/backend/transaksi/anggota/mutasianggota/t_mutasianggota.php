...
if (isset($_POST["savemutasianggota"])) {
    ...
    try {
        ...
        GetQuery("insert into t_mutasi select UUID(),'$MUTASI_ID', '$CABANG_AWAL', '$CABANG_TUJUAN', '$ANGGOTA_KEY', '$ANGGOTA_ID', '$MUTASI_DESKRIPSI', '$MUTASI_TANGGAL', 0, '$localDateTime', null, null, '$MUTASI_FILE',0,0, '$USER_ID', '$localDateTime'");
        ...
        END AS TOGGLE,
        'Persetujuan Mutasi Anggota',CONCAT('Mutasi a.n ',a.ANGGOTA_NAMA,' dari cabang ',c.CABANG_DESKRIPSI),0,0,'$USER_ID','$localDateTime'
        FROM m_anggota a
...
if (isset($_POST["editmutasianggota"])) {
    ...
    try {
        ...
        GetQuery("update t_mutasi set CABANG_AWAL = '$CABANG_AWAL', CABANG_TUJUAN = '$CABANG_TUJUAN', ANGGOTA_KEY = '$ANGGOTA_KEY', ANGGOTA_ID = '$ANGGOTA_ID', MUTASI_DESKRIPSI = '$MUTASI_DESKRIPSI', MUTASI_TANGGAL = '$MUTASI_TANGGAL', MUTASI_STATUS = 0, MUTASI_STATUS_TANGGAL = '$localDateTime', MUTASI_APPROVE_BY = null, MUTASI_APPROVE_TANGGAL = null, MUTASI_FILE = '$MUTASI_FILE', DELETION_STATUS = 0, INPUT_BY = '$USER_ID', INPUT_DATE = '$localDateTime' where MUTASI_ID = '$MUTASI_ID'");
...
if (isset($_POST["rejectmutasianggota"]) || isset($_POST["notifrejectmutasianggota"])) {
    ...
    try {
        ...
        GetQuery("update t_mutasi set MUTASI_STATUS = 2, MUTASI_APPROVE_BY = '$USER_ID', MUTASI_APPROVE_TANGGAL = '$localDateTime' where MUTASI_ID = '$MUTASI_ID'");
    ...
    try {
        ...
        if ($EVENT_ACTION == "reset") {
            ...
            CASE
                ...
                'open-ViewNotifMutasi'
            END AS TOGGLE,
            'Persetujuan Mutasi Anggota','Mutasi a.n $ANGGOTA_NAMA dari cabang $CABANG_DESKRIPSI', 0, 0, '$USER_ID', '$localDateTime'
            FROM m_anggota
            ...
            GetQuery("insert into t_mutasi_log select uuid(), MUTASI_ID, CABANG_AWAL, CABANG_TUJUAN, ANGGOTA_KEY, MUTASI_DESKRIPSI, MUTASI_TANGGAL, MUTASI_STATUS, MUTASI_STATUS_TANGGAL, MUTASI_APPROVE_BY, MUTASI_APPROVE_TANGGAL, MUTASI_FILE, DELETION_STATUS, 'D', '$USER_ID', '$localDateTime' from t_mutasi where MUTASI_ID = '$MUTASI_ID'");
