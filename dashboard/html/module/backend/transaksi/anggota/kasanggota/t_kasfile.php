        ...
        while ($data = $getData->fetch(PDO::FETCH_ASSOC)) {
            ...
            class MYPDF extends TCPDF {
                ...
                public function Footer() {
                    ...
                    $this->write2DBarcode($URL.'/dashboard/html/assets/token/tokenverify.php?id='.$id.'&data='.$encodedAnggota, 'QRCODE,H', 15, 240, 25, 25, $style, 'N');
                    if ($INPUT_BY) {
                        $this->write2DBarcode($URL.'/dashboard/html/assets/token/tokenverify.php?id='.$id.'&data='.$encodedKoor, 'QRCODE,H', 160, 240, 25, 25, $style, 'N');
                    }
                    $this->Ln(3);
