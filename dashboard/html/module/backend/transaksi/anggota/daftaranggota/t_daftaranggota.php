...
if (isset($_POST["savedaftaranggota"])) {
    ...
    try {
        ...
        GetQuery("insert into m_anggota select uuid(), '$result.$year.$ANGGOTA_ID', '$CABANG_KEY', '$TINGKATAN_ID', '$ANGGOTA_KTP', '$ANGGOTA_NAMA', '$ANGGOTA_ALAMAT', '$ANGGOTA_PEKERJAAN', '$ANGGOTA_KELAMIN', '$ANGGOTA_TEMPAT_LAHIR', '$ANGGOTA_TANGGAL_LAHIR', '$ANGGOTA_HP', '$ANGGOTA_EMAIL', '$idCardFileDestination', '$ANGGOTA_JOIN', null, '0', '$USER_ID', now()");
...
if (isset($_POST["editdaftaranggota"])) {
    ...
    try {
        ...
        GetQuery("update m_anggota set CABANG_KEY = '$CABANG_KEY', TINGKATAN_ID = '$TINGKATAN_ID', ANGGOTA_KTP = '$ANGGOTA_KTP', ANGGOTA_NAMA = '$ANGGOTA_NAMA', ANGGOTA_ALAMAT = '$ANGGOTA_ALAMAT', ANGGOTA_PEKERJAAN = '$ANGGOTA_PEKERJAAN', ANGGOTA_KELAMIN = '$ANGGOTA_KELAMIN', ANGGOTA_TEMPAT_LAHIR = '$ANGGOTA_TEMPAT_LAHIR', ANGGOTA_TANGGAL_LAHIR = '$ANGGOTA_TANGGAL_LAHIR', ANGGOTA_HP = '$ANGGOTA_HP', ANGGOTA_EMAIL = '$ANGGOTA_EMAIL', ANGGOTA_JOIN = '$ANGGOTA_JOIN', INPUT_BY = '$USER_ID', INPUT_DATE = now() where ANGGOTA_KEY = '$ANGGOTA_KEY'");
