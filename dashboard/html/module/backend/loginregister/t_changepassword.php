...
if (isset($_POST["changepassword"])) {
    ...
    elseif (password_verify($OLDPASSWORD, $USER_PASSWORD)) {
        ...
        GetQuery("insert into m_user_log select UUID(), ANGGOTA_KEY, ANGGOTA_ID, '$PASSWORD', '$CONFIRMPASSWORD', USER_STATUS, '$USER_ID', '$localDateTime', 'U' from m_user where ANGGOTA_KEY = '$USER_KEY'");
