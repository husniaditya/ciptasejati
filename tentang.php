	...
	<body class="alternative-font-7">
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div class="container container-xl-custom">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="text-dark font-weight-bold">Tentang Kami</h1>
							</div>
								...
								<div class="cascading-images-wrapper">
									<div class="cascading-images position-relative">
										<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
											<img src="img/demos/renewable-energy/generic/tentang-1.jpg" class="appear-animation" width="500" alt="" data-appear-animation="expandIn" data-appear-animation-duration="600ms" />
										</div>
										<div class="position-absolute w-100" style="top: 41%; left: -30%;">
											<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
												<img src="img/demos/renewable-energy/generic/tentang-2.jpg" class="appear-animation" width="500" alt="" data-appear-animation="expandIn" data-appear-animation-delay="300" data-appear-animation-duration="600ms" />
											</div>
										</div>
										<div class="position-absolute w-100" style="top: 75%; left: 30%;">
											<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.4, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
												<img src="img/demos/renewable-energy/generic/logo-tentang.png" class="appear-animation" width="300" alt="" data-appear-animation="expandIn" data-appear-animation-delay="600" data-appear-animation-duration="600ms" />
											</div>
										</div>
									</div>
								</div>	
						...
						<div class="col-lg-4">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Arti Lambang</h4>
									<ul>
										<li>BINTANG LIMA melambangkan Ketuhanan Yang Maha Esa</li>
										<li>RANTAI melambangkan persaudaraan</li>
										<li>CAKRA melambangkan senjata bela diri</li>
										<li>SEGI LIMA melambangkan Pancasila</li>
										<li>TANGAN melambangkan kesungguhan hati dan berserah diri kepada Tuhan Yang Maha Esa</li>
										<li>SABUK MERAH PUTIH melambangkan Nasionalisme</li>
										<li>LINGKARAN melambangkan suatu wadah dalam hal ini adalah Institutt Seni Bela Diri Silat “CIPTA SEJATI”</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Arti Warna</h4>
									<ul>
										<li>BIRU melambangkan perdamaian</li>
										<li>KUNING melambangkan cita-cita</li>
										<li>PUTIH melambangkan Kesucian</li>
										<li>MERAH melambangkan Keberanian</li>
										<li>HITAM melambangkan Kejujuran</li>
										<li>UNGU melambangkan Cinta Kasih</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="card border-0 bg-color-light box-shadow-1 box-shadow-1-hover anim-hover-translate-top-10px transition-3ms">
								<div class="card-body text-center text-lg-start m-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="700" data-plugin-options="{'minWindowWidth': 0}">
									<img height="90" src="img/demos/renewable-energy/icons/logo.png" alt="" />
									<h4 class="font-weight-bold mt-4">Makna Keseluruhan</h4>
									<li>Dengan rahmad Tuhan Yang Maha Esa dan didorong oleh cita-cita suci yang luhur serta kejujuran, kita harus berani membela kebenaran demi mewujudkan perdamaian yang dilandasi persatuan, persaudaraan dan semangat nasionalisme serta sanggup menggembangkan kemampuan yang dimiliki dimana kemampuan itu berasal dari jiwa dan semangat yang bersumber dari dalam / spiritual.</li>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="h-100 m-0">
								<div class="row m-0">
									<div class="col-half-section col-half-section-left py-5">
										<div class="px-3 py-5 my-4">
											<h3 class="mb-3">VISI</h3>
											<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vestibulum, libero vel tristique sodales, dui tellus lacinia nibh, eu auctor nisl est sed metus.</p>
										</div>
									</div>
								</div>
							</div>
				...
				<section class="my-0 py-5 border-0 bg-color-tertiary text-color-light p-relative overflow-hidden">
					...
					<div class="container container-xl-custom">
						<div class="row justify-content-between align-items-center py-5">
							<div class="col-lg-3">
								<h4 class="text-warning text-3 font-weight-bold mb-2">Cipta Sejati Indonesia</h4>
								<h3 class="text-light mb-3">Guru Besar </h3>
								<p class="text-light mb-5 mb-lg-0">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendreriast ehicula leo</p>
							</div>
							<div class="col-lg-8">
								<div class="carousel-half-full-width-wrapper carousel-half-full-width-right">
									<div class="owl-carousel owl-theme carousel-half-full-width-right nav-style-1 nav-dark nav-font-size-lg mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '768': {'items': 3}, '992': {'items': 3}, '1200': {'items': 3}}, 'loop': true, 'nav': true, 'dots': false, 'margin': 20}">
										<div class="p-relative">
											<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
												<span class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content">
													<img src="img/demos/renewable-energy/gallery/gallery-1.jpg" class="img-fluid" alt="">
												</span>
											</span>
											<h4 class="text-warning font-weight-bold mt-4">Alpha</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-light"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-light"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-light"></i> Gelar : Guru Muda</li>
											</ul>
										</div>
										<div class="p-relative">
											<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
												<span class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content">
													<img src="img/demos/renewable-energy/gallery/gallery-2.jpg" class="img-fluid" alt="">
												</span>
											</span>
											<h4 class="text-warning font-weight-bold mt-4">Beta</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-light"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-light"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-light"></i> Gelar : Guru Muda</li>
										...
										<div class="p-relative">
											<span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
												<span class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content">
													<img src="img/demos/renewable-energy/gallery/gallery-3.jpg" class="img-fluid" alt="">
												</span>
											</span>
											<h4 class="text-warning font-weight-bold mt-4">Charlie</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-light"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-light"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-light"></i> Gelar : Guru Muda</li>
										...
										<div class="p-relative">
											...
											<h4 class="text-warning font-weight-bold mt-4">Delta</h4>
											<ul class="list list-icons list-danger font-weight-medium mt-3">
												<li><i class="fas fa-code-branch text-light"></i> Cabang : Surabaya</li>
												<li><i class="fas fa-chart-simple text-light"></i> Tingkatan : Merah-I</li>
												<li><i class="fas fa-pen text-light"></i> Gelar : Guru Muda</li>
